...
<head>
    ...
    <!-- Font-->
    <link rel="stylesheet" type="text/css" href="{{ asset('installer/css/opensans-font.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('installer/css/montserrat-font.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('installer/fonts/material-design-iconic-font/css/material-design-iconic-font.min.css') }}">
    <!-- Main Style Css -->
                    ...
                    <section>
                        <div class="inner">
                            ...
                            <div class="wizard-body" id="applicationSetup">
                                @include('installer.partials.application-setup')
                            </div>
                        </div>
                    </section>
                    <!-- SECTION 3 -->
                    ...
                    <section>
                        <div class="inner">
                            ...
                            <div class="wizard-body" id="databaseSetup">
                                @include('installer.partials.database-setup')
                            </div>
                        </div>
                    </section>
                    <!-- SECTION 4 -->
                    ...
                    <section>
                        <div class="inner">
                            ...
                            <div class="wizard-body" id="confirmFinalize">
                                @include('installer.partials.confirm-finalize')
                            </div>
                        </div>
                    </section>
                </div>
...
<script src="{{ asset('installer/js/jquery.steps.js') }}"></script>
